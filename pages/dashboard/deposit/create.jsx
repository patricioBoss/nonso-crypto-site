    ...
    return (
      <Page title="Deposit Coin">
        <Container maxWidth={themeStretch ? false : "xl"}>
          ...
          <Typography >Effortlessly Fund Your Account with FidelityCryptoPro.  Investing in the future of cryptocurrency has never been easier - with just a few clicks, you can fund your account and embark on a path to financial growth. <span className=" font-bold"> Current Balance: $ {numeral(user.accountBalance).format(
                  "0.00"
                )}</span></Typography>
